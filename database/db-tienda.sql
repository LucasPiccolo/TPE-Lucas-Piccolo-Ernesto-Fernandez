...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2023 at 10:58 PM
...
('root', '[{\"db\":\"tienda\",\"table\":\"usuarios\"},{\"db\":\"tienda\",\"table\":\"juegos\"},{\"db\":\"tienda\",\"table\":\"desarrolladores\"},{\"db\":\"productos\",\"table\":\"productos\"},{\"db\":\"productos\",\"table\":\"categorias\"},{\"db\":\"tareas\",\"table\":\"tareas\"},{\"db\":\"tp2\",\"table\":\"pagos\"},{\"db\":\"prueba\",\"table\":\"transactions\"},{\"db\":\"prueba\",\"table\":\"Transactions\"}]');
...
('root', 'tienda', 'juegos', '{\"CREATE_TIME\":\"2023-10-10 19:00:13\"}', '2023-10-11 21:56:30');
...
('root', '2023-10-14 20:58:04', '{\"Console\\/Mode\":\"collapse\"}');
...
CREATE TABLE `tareas` (
  `id` int(11) NOT NULL,
  `tarea_titulo` varchar(45) NOT NULL,
...
(2, '2012-05-04', 'Francia', 'Electronic Arts'),
(4, '2005-06-12', 'EEUU', 'PopCap Games'),
(5, '2008-09-12', 'Noruega', 'Mojang'),
...
(10, 'Sims 45', '2023-10-03', 2, 'Simulador de vida', 7, 'Sin imagen todavía'),
...
(15, 'FIFA 12', '2011-08-07', 2, 'Juego de fulbo', 5, 'Sin imagen todavía'),
(16, 'Diablo 3', '2012-02-11', 7, 'ARPG muy buen juego', 13, 'Sin imagen todavía');
...
--
ALTER TABLE `juegos`
  MODIFY `juegoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
